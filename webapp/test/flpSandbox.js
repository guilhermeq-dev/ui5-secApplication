		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sec Application",
									"targetURL": "#comlab2devsecapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devsecapplication-display": {
								"semanticObject": "comlab2devsecapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.secapplication",
									"url": sap.ui.require.toUrl("com/lab2dev/secapplication")
								}
							}
						}
					}
